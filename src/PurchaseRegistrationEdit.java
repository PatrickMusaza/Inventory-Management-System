 ...
 * @author Patrick
 */
public class PurchaseRegistrationEdit extends javax.swing.JFrame {

    /**
     * Creates new form PurchaseRegistration
     */
    public PurchaseRegistrationEdit() {
        initComponents();
    ...
    private void PaymentMethod() {
        try {
            ...
            Logger.getLogger(PurchaseRegistrationEdit.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static void setCustomerDetails(String code, String name) {
        PurchaseRegistrationEdit.SupplierID.setText(code);
        PurchaseRegistrationEdit.SupplierName.setText(name);
    }

    public static void setItemDetails(String code, String name) {
        PurchaseRegistrationEdit.ItemCode.setText(code);
        PurchaseRegistrationEdit.ItemName.setText(name);
    }
    ...
    private void totalAmount() {
        try {
            ...
            if (rs.next()) {
                ...
                PurchaseRegistrationEdit.TotalAmount.setText(dfTotal.format(total));
                DecimalFormat dfVAT = new DecimalFormat("#.##");
                PurchaseRegistrationEdit.VAT.setText(dfVAT.format(vat));
            }
        } catch (SQLException ex) {
            Logger.getLogger(PurchaseRegistrationEdit.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        RefreshTable.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        RefreshTable.setText("All Items");
    ...
    private void savePurchaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePurchaseActionPerformed
        ...
        if (!ValidateForm.isInternetReachable()) {
            ...
            String input = PurchaseRegistrationEdit.SupplierID.getText().trim();
            Date input1 = ReleaseDate.getDate();
            ...
            if ((type == false) && (type1 == false)) {
                ...
                String PurchaseCode = PurchaseRegistrationEdit.PurchaseCode.getText();
                Date ReleaseDate = PurchaseRegistrationEdit.ReleaseDate.getDate();
                String Remark = PurchaseRegistrationEdit.Remark.getText();
                String TotalAmount = PurchaseRegistrationEdit.TotalAmount.getText();
                String VAT = PurchaseRegistrationEdit.VAT.getText();
                String SupplierReceipt = PurchaseRegistrationEdit.SupplierReceipt.getText();
                String SupplierSDCD = PurchaseRegistrationEdit.SupplierSDCD.getText();
                String Purchase = null;
                String Method = (String) PurchaseRegistrationEdit.Method.getSelectedItem();
                ...
                try {
                    ...
                    insert.setString(8, PurchaseCode);
                    insert.setString(9, Purchase);
                    insert.setString(10, Username);
                    insert.setString(11, SupplierSDCD);
                    ...
                    PurchaseRegistrationEdit.TotalAmount.setText("");
                    PurchaseRegistrationEdit.PurchaseID.setText("");
                    PurchaseRegistrationEdit.Remark.setText("");
                    PurchaseRegistrationEdit.ReleaseDate.setDate(null);
                    PurchaseRegistrationEdit.SupplierName.setText(null);
                    PurchaseRegistrationEdit.SupplierID.setText(null);
                    PurchaseRegistrationEdit.PurchaseCode.setText("");
                    PurchaseRegistrationEdit.Purchase.setText("Purchase");
                    PurchaseRegistrationEdit.SupplierSDCD.setText("");
                    PurchaseRegistrationEdit.SupplierReceipt.setText("");
    ...
    private void AddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddItemActionPerformed
        ...
        if (!ValidateForm.isInternetReachable()) {
            ...
            String input = PurchaseRegistrationEdit.ItemCode.getText().trim();
            ...
            if (input.isEmpty()) {
                ...
                try {
                    ...
                    String UnitPrice = PurchaseRegistrationEdit.UnitPrice.getText();
                    String SalesPrice = PurchaseRegistrationEdit.SalesPrice.getText();
                    ...
                    ItemName.setText("");
                    Tax.getItemAt(0);
                    PurchaseRegistrationEdit.UnitPrice.setText("");
                    PurchaseRegistrationEdit.SalesPrice.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new ItemListPE().setVisible(true);
        totalAmount();
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        new CustomerListPE().setVisible(true);
        totalAmount();
            ...
            try {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    while (rs.next()) {
                        ...
                        Balance.setString(1, PurchaseID);
    ...
    public static javax.swing.JComboBox<String> Method;
    public static javax.swing.JRadioButton Purchase;
    public static javax.swing.JTextField PurchaseCode;
    public static javax.swing.JTextField PurchaseID;
    public static javax.swing.JTextField PurchaseReason;
    private javax.swing.JButton RefreshTable;
    public static com.toedter.calendar.JDateChooser ReleaseDate;
    ...
    public static javax.swing.JTextField SupplierReceipt;
    public static javax.swing.JTextField SupplierSDCD;
    ...
    public static javax.swing.JTextField VAT;
