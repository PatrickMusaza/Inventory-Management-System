 ...
 * @author Patrick
 */
public class SalesTransactionEdit extends javax.swing.JFrame {

    /**
     * Creates new form SalesTransaction
     */
    public SalesTransactionEdit() {
        initComponents();
    ...
    public static void setCustomerDetails(String code, String name) {
        SalesTransactionEdit.CustomerID.setText(code);
        SalesTransactionEdit.CustomerName.setText(name);
    }

    public static void setItemDetails(String code, String name) {
        SalesTransactionEdit.ItemCode.setText(code);
        SalesTransactionEdit.ItemName.setText(name);
    }
    ...
    private void table_update() {
        ...
        int count;
        String InvoiceID = SalesTransactionEdit.InvoiceID.getText();
        try {
            Connection con = Connect.getConnection();
    ...
    private void totalAmount() {
        try {
            ...
            if (rs.next()) {
                ...
                SalesTransactionEdit.TotalAmount.setText(dfTotal.format(total));
                DecimalFormat dfVAT = new DecimalFormat("#.##");
                SalesTransactionEdit.VAT.setText(dfVAT.format(vat));
            }
        } catch (SQLException ex) {
            Logger.getLogger(SalesTransactionEdit.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Sales Transaction Update");
        setResizable(false);
    ...
    private void saveSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveSaleActionPerformed
        ...
        if (!ValidateForm.isInternetReachable()) {
            ...
            String input = SalesTransactionEdit.CustomerID.getText().trim();
            Date input1 = SalesTransactionEdit.ReleaseDate.getDate();
            ...
            if ((type == false) && (type1 == false)) {
                ...
                String InvoiceID = SalesTransactionEdit.InvoiceID.getText();
                String CustomerID = SalesTransactionEdit.CustomerID.getText();
                String CustomerName = SalesTransactionEdit.CustomerName.getText();
                String PurchaseCode = SalesTransactionEdit.PurchaseCode.getText();
                Date ReleaseDate = SalesTransactionEdit.ReleaseDate.getDate();
                String Remark = SalesTransactionEdit.Remark.getText();
                Date SaleDate = SalesTransactionEdit.SaleDate.getDate();
                String TotalAmount = SalesTransactionEdit.TotalAmount.getText();
                ...
                try {
                    ...
                    SalesTransactionEdit.TotalAmount.setText("");
                    SalesTransactionEdit.InvoiceID.setText("");
                    SalesTransactionEdit.Remark.setText("");
                    SalesTransactionEdit.SaleDate.setDate(null);
                    SalesTransactionEdit.ReleaseDate.setDate(null);
                    SalesTransactionEdit.CustomerName.setText(null);
                    SalesTransactionEdit.CustomerID.setText(null);
                    SalesTransactionEdit.PurchaseCode.setText("");
                    SalesTransactionEdit.Sale.setText("Sale");
    ...
    private void AddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddItemActionPerformed
        ...
        if (!ValidateForm.isInternetReachable()) {
            ...
            String input = SalesTransactionEdit.ItemCode.getText().trim();
            ...
            if (input.isEmpty()) {
                ...
                try {
                    ...
                    code = SalesTransactionEdit.ItemCode.getText();
                ...
                if (a == 1) {
                    try {
                        ...
                        String UnitPrice = SalesTransactionEdit.UnitPrice.getText();
                        String SalesPrice = SalesTransactionEdit.SalesPrice.getText();
                        ...
                        ItemName.setText("");
                        Tax.getItemAt(0);
                        SalesTransactionEdit.UnitPrice.setText("");
                        SalesTransactionEdit.SalesPrice.setText("");
                        this.SalesQty.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new ItemListES().setVisible(true);
        totalAmount();
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        new CustomerListES().setVisible(true);
        totalAmount();
    ...
    private void SalesQtyKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SalesQtyKeyReleased
        ...
        int Qty = Integer.parseInt(this.SalesQty.getText());
        float UnitPrice = Float.parseFloat(this.UnitPrice.getText());
        float total;
        total = Qty * UnitPrice;
    ...
    public static javax.swing.JTextField InvoiceID;
    ...
    public static javax.swing.JRadioButton Sale;
    public static com.toedter.calendar.JDateChooser SaleDate;
