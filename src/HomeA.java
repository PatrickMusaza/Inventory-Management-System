...
public class HomeA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Management.setBackground(new java.awt.Color(0, 51, 0));
        Management.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        Management.setForeground(new java.awt.Color(255, 153, 51));
        Management.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/gear.png"))); // NOI18N
    ...
    private void ManagementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManagementActionPerformed
        ...
        ManagementM management = new ManagementM();
        jpload.jPanelLoader(MainFrame, management);
        this.statementFrame.setForeground(Color.WHITE);
        this.customerFrame.setForeground(Color.WHITE);
        this.saleFrame.setForeground(Color.WHITE);
        this.purchaseFrame.setForeground(Color.WHITE);
