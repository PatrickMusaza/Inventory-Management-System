 ...
 * @author Patrick
 */
public class CustomerListP extends javax.swing.JFrame {
    ...
    private void table_update() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerListP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (row >= 0) {
            ...
            if (evt.getClickCount() == 1) {
                // Single click event
                PurchaseRegistration.setCustomerDetails(code, name);
